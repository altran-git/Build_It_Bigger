...
public class Joker {
  ...
  public Joker() {
    ...
    jokeArray[1] = "Q: Why can't a blonde dial 911?\nA: She can't find the eleven.";
    jokeArray[2] = "Yo momma is so fat, I took a picture of her last Christmas and it's still printing.";
    jokeArray[3] = "Q: What did one cannibal say to the other while they were eating a clown?\nA: Does this taste funny to you?";
    jokeArray[4] = "Q: What did the DNA say to the other DNA?\nA: Do these genes make my butt look fat.";
    jokeArray[5] = "You may be a square, baby, but you're round in all the right places.";
    jokeArray[6] = "Q: What did the farmer use to make crop circles?\nA: A Protractor";
